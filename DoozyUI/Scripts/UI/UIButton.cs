...
namespace DoozyUI
{
    ...
    public class UIButton : MonoBehaviour
    {
        ...
        /// </summary>
        void CheckIfThisIsAlsoAnUIElementButton()
        {
            UIElement uiElement = GetComponent<UIElement>();
            if (uiElement != null) //we check that this is also an UIElement
            {
                isThisButtonAnUIElement = true;
            }
            else
            {
                isThisButtonAnUIElement = false;
            }
        }
