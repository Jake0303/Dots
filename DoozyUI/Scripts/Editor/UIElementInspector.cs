...
public class UIElementInspector : Editor
{
    ...
    int[] outAnimationSoundIndex = new int[8]
   {
    ...
    void UpdateAnimationPresetsFromFiles()
    {
        ...
        if (DoozyUI.UIManager.IsStringInArray(inAnimationPresets, GetUIElement.inAnimationsPresetName) == false) //Check the the current peset name exists in the presets array
        {
        ...
        GetUIElement.activeInAnimationsPresetIndex = DoozyUI.UIManager.GetIndexForStringInArray(inAnimationPresets, GetUIElement.inAnimationsPresetName);

        loopAnimationPresets = GetUIElement.GetLoopAnimationsPresetNames;
        if (DoozyUI.UIManager.IsStringInArray(loopAnimationPresets, GetUIElement.loopAnimationsPresetName) == false) //Check the the current peset name exists in the presets array
        {
        ...
        GetUIElement.activeLoopAnimationsPresetIndex = DoozyUI.UIManager.GetIndexForStringInArray(loopAnimationPresets, GetUIElement.loopAnimationsPresetName);

        outAnimationPresets = GetUIElement.GetOutAnimationsPresetNames;
        if (DoozyUI.UIManager.IsStringInArray(outAnimationPresets, GetUIElement.outAnimationsPresetName) == false) //Check the the current peset name exists in the presets array
        {
        ...
        GetUIElement.activeOutAnimationsPresetIndex = DoozyUI.UIManager.GetIndexForStringInArray(outAnimationPresets, GetUIElement.outAnimationsPresetName);
    }
    #endregion
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (Application.isPlaying == false)
        {
            ...
            EditorGUILayout.BeginHorizontal();
            {
                ...
                if (GetUIElement.LANDSCAPE)
                {
                    if (GUILayout.Button(DoozyUIResources.ButtonLandscapeEnabled, GUIStyle.none, GUILayout.Width(87), GUILayout.Height(21.75f)))
                        GetUIElement.LANDSCAPE = false;
                }
                else
                {
                    if (GUILayout.Button(DoozyUIResources.ButtonLandscapeDisabled, GUIStyle.none, GUILayout.Width(87), GUILayout.Height(21.75f)))
                        GetUIElement.LANDSCAPE = true;
                }

                GUILayout.Space(8);

                if (GetUIElement.PORTRAIT)
                {
                    if (GUILayout.Button(DoozyUIResources.ButtonPortraitEnabled, GUIStyle.none, GUILayout.Width(87), GUILayout.Height(21.75f)))
                        GetUIElement.PORTRAIT = false;
                }
                else
                {
                    if (GUILayout.Button(DoozyUIResources.ButtonPortraitDisabled, GUIStyle.none, GUILayout.Width(87), GUILayout.Height(21.75f)))
                        GetUIElement.PORTRAIT = true;
                }
            }
            ...
            else
            {
                if (newElementName == false && renameElementName == false && deleteElementName == false)
                {
                    ...
                    if (DoozyUI.UIManager.GetIndexForElementName(GetUIElement.elementName) == -1)
                    {
                ...
                if (newElementName == false && renameElementName == false && deleteElementName == false)
                {
                    if (GetUIElement.elementName.Equals(DoozyUI.UIManager.DEFAULT_ELEMENT_NAME))
                    {
                    ...
                    else
                    {
                        ...
                        {
                            if (tempElementNameString.Equals(DoozyUI.UIManager.DEFAULT_ELEMENT_NAME))
                            {
                                Debug.Log("[DoozyUI] You cannot (and should not) rename the default element name.");
                                return;
                            }
                            tempElementNameString = GetUIElement.elementName;
                ...
                else if (newElementName == true)
                {
                    ...
                    {
                        DoozyUI.UIManager.TrimStartAndEndSpaces(tempElementNameString);
                        if (tempElementNameString.Equals(string.Empty) == false                         //we make sure the new name is not empty
                            && tempElementNameString.Equals(DoozyUI.UIManager.DEFAULT_ELEMENT_NAME) == false    //we check that is not the default name
                            && DoozyUI.UIManager.GetIndexForElementName(tempElementNameString) == -1)            //we make sure there are no duplicates
                        {
                ...
                else if (deleteElementName == true)
                {
                    ...
                    if (GUILayout.Button("yes", GUILayout.Width(89), GUILayout.Height(16)))
                    {
                        ...
                        {
                            Debug.Log("[DoozyUI] You cannot (and should not) delete the default element name '" + DoozyUI.UIManager.DEFAULT_ELEMENT_NAME + "'.");
                        }
            ...
            if (sp_animateAtStart.boolValue)
            {
                sp_startHidden.boolValue = false;
            }
            ...
            EditorGUILayout.BeginHorizontal();
            tex = DoozyUIResources.IconInDisabled;
            if (sp_useInAnimations.boolValue)
            {
                tex = DoozyUIResources.IconInEnabled;
            }
            if (GUILayout.Button(tex, GUIStyle.none, GUILayout.Width(48), GUILayout.Height(24)))
            {
            ...
            if (GUILayout.Button(tex, GUIStyle.none, GUILayout.Width(36), GUILayout.Height(24)))
            {
            ...
            tex = DoozyUIResources.IconLoopDisabled;
            if (sp_useLoopAnimations.boolValue)
            {
                tex = DoozyUIResources.IconLoopEnabled;
            }
            if (GUILayout.Button(tex, GUIStyle.none, GUILayout.Width(48), GUILayout.Height(24)))
            {
            ...
            tex = DoozyUIResources.IconOutDisabled;
            if (sp_useOutAnimations.boolValue)
            {
                tex = DoozyUIResources.IconOutEnabled;
            }
            if (GUILayout.Button(tex, GUIStyle.none, GUILayout.Width(48), GUILayout.Height(24)))
            {
        ...
        if (sp_useInAnimations.boolValue)
        {
            ...
            if (sp_moveIn_enabled.boolValue)
            {
                ...
                if (DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.moveInSoundAtStart) == -1)
                {
                    DoozyUIRedundancyCheck.UIElementRedundancyCheck(GetUIElement);
                }
                inAnimationSoundIndex[0] = DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.moveInSoundAtStart);
                inAnimationSoundIndex[0] = EditorGUILayout.Popup(inAnimationSoundIndex[0], elementSounds, GUILayout.Width(140));
                GetUIElement.moveIn.soundAtStartReference = DoozyUI.UIManager.GetDoozyUIData.elementSounds[inAnimationSoundIndex[0]]; //we reference the class not the value (we need a reference)
                ...
                if (DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.moveInSoundAtFinish) == -1)
                {
                    DoozyUIRedundancyCheck.UIElementRedundancyCheck(GetUIElement);
                }
                inAnimationSoundIndex[1] = DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.moveInSoundAtFinish);
                inAnimationSoundIndex[1] = EditorGUILayout.Popup(inAnimationSoundIndex[1], elementSounds, GUILayout.Width(140));
                GetUIElement.moveIn.soundAtFinishReference = DoozyUI.UIManager.GetDoozyUIData.elementSounds[inAnimationSoundIndex[1]]; //we reference the class not the value (we need a reference)
            ...
            if (sp_rotationIn_enabled.boolValue)
            {
                ...
                if (DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.rotationInSoundAtStart) == -1)
                {
                    DoozyUIRedundancyCheck.UIElementRedundancyCheck(GetUIElement);
                }
                inAnimationSoundIndex[2] = DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.rotationInSoundAtStart);
                inAnimationSoundIndex[2] = EditorGUILayout.Popup(inAnimationSoundIndex[2], elementSounds, GUILayout.Width(140));
                GetUIElement.rotationIn.soundAtStartReference = DoozyUI.UIManager.GetDoozyUIData.elementSounds[inAnimationSoundIndex[2]]; //we reference the class not the value (we need a reference)
                ...
                if (DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.rotationInSoundAtFinish) == -1)
                {
                    DoozyUIRedundancyCheck.UIElementRedundancyCheck(GetUIElement);
                }
                inAnimationSoundIndex[3] = DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.rotationInSoundAtFinish);
                inAnimationSoundIndex[3] = EditorGUILayout.Popup(inAnimationSoundIndex[3], elementSounds, GUILayout.Width(140));
                GetUIElement.rotationIn.soundAtFinishReference = DoozyUI.UIManager.GetDoozyUIData.elementSounds[inAnimationSoundIndex[3]]; //we reference the class not the value (we need a reference)
            ...
            if (sp_scaleIn_enabled.boolValue)
            {
                ...
                if (DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.scaleInSoundAtStart) == -1)
                {
                    DoozyUIRedundancyCheck.UIElementRedundancyCheck(GetUIElement);
                }
                inAnimationSoundIndex[4] = DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.scaleInSoundAtStart);
                inAnimationSoundIndex[4] = EditorGUILayout.Popup(inAnimationSoundIndex[4], elementSounds, GUILayout.Width(140));
                GetUIElement.scaleIn.soundAtStartReference = DoozyUI.UIManager.GetDoozyUIData.elementSounds[inAnimationSoundIndex[4]]; //we reference the class not the value (we need a reference)
                ...
                if (DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.scaleInSoundAtFinish) == -1)
                {
                    DoozyUIRedundancyCheck.UIElementRedundancyCheck(GetUIElement);
                }
                inAnimationSoundIndex[5] = DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.scaleInSoundAtFinish);
                inAnimationSoundIndex[5] = EditorGUILayout.Popup(inAnimationSoundIndex[5], elementSounds, GUILayout.Width(140));
                GetUIElement.scaleIn.soundAtFinishReference = DoozyUI.UIManager.GetDoozyUIData.elementSounds[inAnimationSoundIndex[5]]; //we reference the class not the value (we need a reference)
            ...
            if (sp_fadeIn_enabled.boolValue)
            {
                ...
                if (DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.fadeInSoundAtStart) == -1)
                {
                    DoozyUIRedundancyCheck.UIElementRedundancyCheck(GetUIElement);
                }
                inAnimationSoundIndex[6] = DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.fadeInSoundAtStart);
                inAnimationSoundIndex[6] = EditorGUILayout.Popup(inAnimationSoundIndex[6], elementSounds, GUILayout.Width(140));
                GetUIElement.fadeIn.soundAtStartReference = DoozyUI.UIManager.GetDoozyUIData.elementSounds[inAnimationSoundIndex[6]]; //we reference the class not the value (we need a reference)
                ...
                if (DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.fadeInSoundAtFinish) == -1)
                {
                    DoozyUIRedundancyCheck.UIElementRedundancyCheck(GetUIElement);
                }
                inAnimationSoundIndex[7] = DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.fadeInSoundAtFinish);
                inAnimationSoundIndex[7] = EditorGUILayout.Popup(inAnimationSoundIndex[7], elementSounds, GUILayout.Width(140));
                GetUIElement.fadeIn.soundAtFinishReference = DoozyUI.UIManager.GetDoozyUIData.elementSounds[inAnimationSoundIndex[7]]; //we reference the class not the value (we need a reference)
        ...
        if (sp_useLoopAnimations.boolValue)
        {
            ...
            if (sp_moveLoop_enabled.boolValue)
            {
                ...
                if (DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.moveLoopSoundAtStart) == -1)
                {
                    DoozyUIRedundancyCheck.UIElementRedundancyCheck(GetUIElement);
                }
                loopAnimationSoundIndex[0] = DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.moveLoopSoundAtStart);
                loopAnimationSoundIndex[0] = EditorGUILayout.Popup(loopAnimationSoundIndex[0], elementSounds, GUILayout.Width(140));
                GetUIElement.moveLoop.soundAtStartReference = DoozyUI.UIManager.GetDoozyUIData.elementSounds[loopAnimationSoundIndex[0]]; //we reference the class not the value (we need a reference)
                ...
                if (DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.moveLoopSoundAtFinish) == -1)
                {
                    DoozyUIRedundancyCheck.UIElementRedundancyCheck(GetUIElement);
                }
                loopAnimationSoundIndex[1] = DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.moveLoopSoundAtFinish);
                loopAnimationSoundIndex[1] = EditorGUILayout.Popup(loopAnimationSoundIndex[1], elementSounds, GUILayout.Width(140));
                GetUIElement.moveLoop.soundAtFinishReference = DoozyUI.UIManager.GetDoozyUIData.elementSounds[loopAnimationSoundIndex[1]]; //we reference the class not the value (we need a reference)
            ...
            if (sp_rotationLoop_enabled.boolValue)
            {
                ...
                if (DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.rotationLoopSoundAtStart) == -1)
                {
                    DoozyUIRedundancyCheck.UIElementRedundancyCheck(GetUIElement);
                }
                loopAnimationSoundIndex[2] = DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.rotationLoopSoundAtStart);
                loopAnimationSoundIndex[2] = EditorGUILayout.Popup(loopAnimationSoundIndex[2], elementSounds, GUILayout.Width(140));
                GetUIElement.rotationLoop.soundAtStartReference = DoozyUI.UIManager.GetDoozyUIData.elementSounds[loopAnimationSoundIndex[2]]; //we reference the class not the value (we need a reference)
                ...
                if (DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.rotationLoopSoundAtFinish) == -1)
                {
                    DoozyUIRedundancyCheck.UIElementRedundancyCheck(GetUIElement);
                }
                loopAnimationSoundIndex[3] = DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.rotationLoopSoundAtFinish);
                loopAnimationSoundIndex[3] = EditorGUILayout.Popup(loopAnimationSoundIndex[3], elementSounds, GUILayout.Width(140));
                GetUIElement.rotationLoop.soundAtFinishReference = DoozyUI.UIManager.GetDoozyUIData.elementSounds[loopAnimationSoundIndex[3]]; //we reference the class not the value (we need a reference)
            ...
            if (sp_scaleLoop_enabled.boolValue)
            {
                ...
                if (DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.scaleLoopSoundAtStart) == -1)
                {
                    DoozyUIRedundancyCheck.UIElementRedundancyCheck(GetUIElement);
                }
                loopAnimationSoundIndex[4] = DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.scaleLoopSoundAtStart);
                loopAnimationSoundIndex[4] = EditorGUILayout.Popup(loopAnimationSoundIndex[4], elementSounds, GUILayout.Width(140));
                GetUIElement.scaleLoop.soundAtStartReference = DoozyUI.UIManager.GetDoozyUIData.elementSounds[loopAnimationSoundIndex[4]]; //we reference the class not the value (we need a reference)
                ...
                if (DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.scaleLoopSoundAtFinish) == -1)
                {
                    DoozyUIRedundancyCheck.UIElementRedundancyCheck(GetUIElement);
                }
                loopAnimationSoundIndex[5] = DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.scaleLoopSoundAtFinish);
                loopAnimationSoundIndex[5] = EditorGUILayout.Popup(loopAnimationSoundIndex[5], elementSounds, GUILayout.Width(140));
                GetUIElement.scaleLoop.soundAtFinishReference = DoozyUI.UIManager.GetDoozyUIData.elementSounds[loopAnimationSoundIndex[5]]; //we reference the class not the value (we need a reference)
            ...
            if (sp_fadeLoop_enabled.boolValue)
            {
                ...
                if (DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.fadeLoopSoundAtStart) == -1)
                {
                    DoozyUIRedundancyCheck.UIElementRedundancyCheck(GetUIElement);
                }
                loopAnimationSoundIndex[6] = DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.fadeLoopSoundAtStart);
                loopAnimationSoundIndex[6] = EditorGUILayout.Popup(loopAnimationSoundIndex[6], elementSounds, GUILayout.Width(140));
                GetUIElement.fadeLoop.soundAtStartReference = DoozyUI.UIManager.GetDoozyUIData.elementSounds[loopAnimationSoundIndex[6]]; //we reference the class not the value (we need a reference)
                ...
                if (DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.fadeLoopSoundAtFinish) == -1)
                {
                    DoozyUIRedundancyCheck.UIElementRedundancyCheck(GetUIElement);
                }
                loopAnimationSoundIndex[7] = DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.fadeLoopSoundAtFinish);
                loopAnimationSoundIndex[7] = EditorGUILayout.Popup(loopAnimationSoundIndex[7], elementSounds, GUILayout.Width(140));
                GetUIElement.fadeLoop.soundAtFinishReference = DoozyUI.UIManager.GetDoozyUIData.elementSounds[loopAnimationSoundIndex[7]]; //we reference the class not the value (we need a reference)
        ...
        if (sp_useOutAnimations.boolValue)
        {
            ...
            if (sp_moveOut_enabled.boolValue)
            {
                ...
                if (DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.moveOutSoundAtStart) == -1)
                {
                    DoozyUIRedundancyCheck.UIElementRedundancyCheck(GetUIElement);
                }
                outAnimationSoundIndex[0] = DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.moveOutSoundAtStart);
                outAnimationSoundIndex[0] = EditorGUILayout.Popup(outAnimationSoundIndex[0], elementSounds, GUILayout.Width(140));
                GetUIElement.moveOut.soundAtStartReference = DoozyUI.UIManager.GetDoozyUIData.elementSounds[outAnimationSoundIndex[0]]; //we reference the class not the value (we need a reference)
                ...
                if (DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.moveOutSoundAtFinish) == -1)
                {
                    DoozyUIRedundancyCheck.UIElementRedundancyCheck(GetUIElement);
                }
                outAnimationSoundIndex[1] = DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.moveOutSoundAtFinish);
                outAnimationSoundIndex[1] = EditorGUILayout.Popup(outAnimationSoundIndex[1], elementSounds, GUILayout.Width(140));
                GetUIElement.moveOut.soundAtFinishReference = DoozyUI.UIManager.GetDoozyUIData.elementSounds[outAnimationSoundIndex[1]]; //we reference the class not the value (we need a reference)
            ...
            if (sp_rotationOut_enabled.boolValue)
            {
                ...
                if (DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.rotationOutSoundAtStart) == -1)
                {
                    DoozyUIRedundancyCheck.UIElementRedundancyCheck(GetUIElement);
                }
                outAnimationSoundIndex[2] = DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.rotationOutSoundAtStart);
                outAnimationSoundIndex[2] = EditorGUILayout.Popup(outAnimationSoundIndex[2], elementSounds, GUILayout.Width(140));
                GetUIElement.rotationOut.soundAtStartReference = DoozyUI.UIManager.GetDoozyUIData.elementSounds[outAnimationSoundIndex[2]]; //we reference the class not the value (we need a reference)
                ...
                if (DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.rotationOutSoundAtFinish) == -1)
                {
                    DoozyUIRedundancyCheck.UIElementRedundancyCheck(GetUIElement);
                }
                outAnimationSoundIndex[3] = DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.rotationOutSoundAtFinish);
                outAnimationSoundIndex[3] = EditorGUILayout.Popup(outAnimationSoundIndex[3], elementSounds, GUILayout.Width(140));
                GetUIElement.rotationOut.soundAtFinishReference = DoozyUI.UIManager.GetDoozyUIData.elementSounds[outAnimationSoundIndex[3]]; //we reference the class not the value (we need a reference)
            ...
            if (sp_scaleOut_enabled.boolValue)
            {
                ...
                if (DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.scaleOutSoundAtStart) == -1)
                {
                    DoozyUIRedundancyCheck.UIElementRedundancyCheck(GetUIElement);
                }
                outAnimationSoundIndex[4] = DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.scaleOutSoundAtStart);
                outAnimationSoundIndex[4] = EditorGUILayout.Popup(outAnimationSoundIndex[4], elementSounds, GUILayout.Width(140));
                GetUIElement.scaleOut.soundAtStartReference = DoozyUI.UIManager.GetDoozyUIData.elementSounds[outAnimationSoundIndex[4]]; //we reference the class not the value (we need a reference)
                ...
                if (DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.scaleOutSoundAtFinish) == -1)
                {
                    DoozyUIRedundancyCheck.UIElementRedundancyCheck(GetUIElement);
                }
                outAnimationSoundIndex[5] = DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.scaleOutSoundAtFinish);
                outAnimationSoundIndex[5] = EditorGUILayout.Popup(outAnimationSoundIndex[5], elementSounds, GUILayout.Width(140));
                GetUIElement.scaleOut.soundAtFinishReference = DoozyUI.UIManager.GetDoozyUIData.elementSounds[outAnimationSoundIndex[5]]; //we reference the class not the value (we need a reference)
            ...
            if (sp_fadeOut_enabled.boolValue)
            {
                ...
                if (DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.fadeOutSoundAtStart) == -1)
                {
                    DoozyUIRedundancyCheck.UIElementRedundancyCheck(GetUIElement);
                }
                outAnimationSoundIndex[6] = DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.fadeOutSoundAtStart);
                outAnimationSoundIndex[6] = EditorGUILayout.Popup(outAnimationSoundIndex[6], elementSounds, GUILayout.Width(140));
                GetUIElement.fadeOut.soundAtStartReference = DoozyUI.UIManager.GetDoozyUIData.elementSounds[outAnimationSoundIndex[6]]; //we reference the class not the value (we need a reference)
                ...
                if (DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.fadeOutSoundAtFinish) == -1)
                {
                    DoozyUIRedundancyCheck.UIElementRedundancyCheck(GetUIElement);
                }
                outAnimationSoundIndex[7] = DoozyUI.UIManager.GetIndexForElementSound(GetUIElement.fadeOutSoundAtFinish);
                outAnimationSoundIndex[7] = EditorGUILayout.Popup(outAnimationSoundIndex[7], elementSounds, GUILayout.Width(140));
                GetUIElement.fadeOut.soundAtFinishReference = DoozyUI.UIManager.GetDoozyUIData.elementSounds[outAnimationSoundIndex[7]]; //we reference the class not the value (we need a reference)
